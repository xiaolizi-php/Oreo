<?php
require_once SYSTEM_ROOT."oreo_static/pay/wxpay/WxPay.Exception.php";
require_once SYSTEM_ROOT."oreo_static/pay/wxpay/WxPay.Config.php";
require_once SYSTEM_ROOT."oreo_static/pay/wxpay/WxPay.Data.php";
