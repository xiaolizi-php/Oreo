                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <small class="text-muted">我的名称: </small>
                                                                 ...
                                                                 <hr>
                                                                 <small class="text-muted">我的账号: </small>
                                                                 <p class="m-b-0" style="margin-top: 1em;"><?php echo $userrow['id']?></p>
                                                                 <hr>
																 <small class="text-muted">保密手机: </small>
																 <?php if($conf['mail_cloud']==2&&$userrow['phone']==0||!$userrow['phone']){ ?>
																 <button type="button" class="btn btn-success" data-toggle="modal"  style="float: right;"onclick="window.location.href='/user/oreo_my_phone.php'">绑定</button>
																 <?php } ?>
...
function invokeSettime(obj) {
				...
				$(document).ready(function () {
					...
					$("#bangdingsjhm").click(function () {
						...
						$.ajax({
							type: "POST",
							url: "ajax2.php?act=verifycodesjbd",
							data: {code: code},
							dataType: 'json',
							success: function (data) {
								layer.close(ii);
