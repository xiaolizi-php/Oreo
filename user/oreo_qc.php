                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">QQ互联管理</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">QQ互联管理</h4>
                                      ...
                                      <div class="text-lg-left">
                                        ...
                                        <th>成功调用 </th>
									 	<th>操作</th>
												...
												<?php
$numrows=$DB->query("SELECT count(*) from oreo_qcback WHERE userid='$pid' ")->fetchColumn();
$pagesize=10;
...
$offset=$pagesize*($page - 1);												
								$rs=$DB->query("SELECT * FROM oreo_qcback WHERE userid='$pid' order by id desc limit $offset,$pagesize"); 
                                     while($row = $rs->fetch())
                                      {
										    if($row['state']==1){
						...
						<div id="shanchu" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="text-center mt-2 mb-4">
                                                         <i class="mdi mdi-delete-forever mr-1"> 删除QQ互联</i>
                                                        </div>
												...
												<div class="form-group">
                                                    <label>回调链接:</label>
                                                    <div>
													 <input type="text" class="form-control ca1"  name="urls"  readonly="readonly" />
										...
										<div id="tianjia" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="text-center mt-2 mb-4">
                                                         <i class="iconfont icon-qq mr-1"> 添加QQ互联</i>
                                                        </div>
														<div class="form-group">
                                                    <label>网站标题:</label>
                                                    <div>
												...
												<div class="form-group mb-3">
													...
													<div class="form-group text-center">
                                                 <button class="btn btn-primary" type="button" id="TianjiaQc">添加</button>
                                                     </div>
                                                </div><!-- /.modal-content -->
                                            </div><!-- /.modal-dialog -->
                                        </div><!-- /.modal -->
 ...
 $('#shanchu').on('show.bs.modal', function (event) {
      ...
      modal.find('.ca3').val(content);	
					...
					$("#shuanchul").click(function () {
						...
						$.ajax({
							type: "POST",
							url: "ajax2.php?act=delete_QcTianjia",
					...
					$("#TianjiaQc").click(function () {
						...
						$.ajax({
							type: "POST",
							url: "ajax2.php?act=New_TianjiaQc",
