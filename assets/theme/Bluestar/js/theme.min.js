...
var BgImgHolder = function () {
        ...
        a.length && a.each(function () {
            var a, e, t, n, o;
            a = $(this), e = a.children("img").attr("src"), t = a.data("bg-position") ? a.data("bg-position") :
                "initial", n = a.data("bg-size") ? a.data("bg-size") : "auto", o = a.data("bg-height") ? a.data(
                    "bg-height") : "100%", a.css("background-image", 'url("' + e + '")').css(
                    "background-position", t).css("background-size", n).css("opacity", "1").css("height", o)
        })
    }(),
    CardActions = function () {
        ...
        a.length && $(n).length && (a.on({
            mouseenter: function () {
                var a, e, t;
                a = $(this), e = a.find(n), t = e.data("animation-in"), e.length && (e.addClass(
                    "in animated " + t), e.one(
            ...
            mouseleave: function () {
                var a, e, t;
                a = $(this), e = a.find(n), t = e.data("animation-out"), e.length && (e.addClass(
                    "animated " + t), e.one(
                    "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
                    function () {
        ...
        a.length && a.each(function () {
            ...
            a = $(this), e = a.data("countdown-date"), a.countdown(e).on("update.countdown", function (a) {
                $(this).html(a.strftime(
                    '<div class="countdown-item"><span class="countdown-digit">%-D</span><span class="countdown-label countdown-days">day%!d</span></div><div class="countdown-item"><span class="countdown-digit">%H</span><span class="countdown-separator">:</span><span class="countdown-label">hr</span></div><div class="countdown-item"><span class="countdown-digit">%M</span><span class="countdown-separator">:</span><span class="countdown-label">min</span></div><div class="countdown-item"><span class="countdown-digit">%S</span><span class="countdown-label">sec</span></div>'
                ))
            })
        })
    }();
...
function (c) {
    c.fn.countTo = function (d) {
        return d = d || {}, c(this).each(function () {
            ...
            o.data("countTo", r), r.interval && clearInterval(r.interval), r.interval = setInterval(
                function () {
                    i++, l(s += e), "function" == typeof t.onUpdate && t.onUpdate.call(n, s), a <= i &&
                        (o.removeData("countTo"), clearInterval(r.interval), s = t.to, "function" ==
                            typeof t.onComplete && t.onComplete.call(n, s))
    ...
    Dropdown = function () {
        ...
        e.length && e.on({
            "hide.bs.dropdown": function () {
                var a;
                (a = e).hasClass("dropdown-animate") && (a.find(".dropdown-menu").addClass("hide"),
                    setTimeout(function () {
                        a.removeClass("hide")
                    }, 300))
            }
    ...
    CustomInputFile = function () {
        ...
        a.length && a.each(function () {
            ...
            s.on("change", function (a) {
                var e, t, n, o, i;
                e = this, t = a, o = s.next("label"), i = o.html(), e && 1 < e.files.length ? n = (e.getAttribute(
                        "data-multiple-caption") || "").replace("{count}", e.files.length) : t.target.value &&
                    (n = t.target.value.split("\\").pop()), n ? o.find("span").html(n) : o.html(i)
            }), s.on("focus", function () {
...
function initMap() {
    ...
    var t = new google.maps.Marker({
        ...
        n = new google.maps.InfoWindow({
            content: '<div class="info-window-content"><h5>Webpixels</h5><h6>Premium Themes 路 UI/UX 路 Web Apps</h6><p>Some more details for directions or company informations...</p></div>'
        });
...
var Highlight = function () {
    ...
    Layout = void $("body").on("click", "[data-action]", function (a) {
        ...
        switch (t) {
            case "offcanvas-open":
                n = e.data("target"), $(n).addClass("open"), $("body").append(
                    '<div class="body-backdrop" data-action="offcanvas-close" data-target=' + n + " />");
                break;
            case "offcanvas-close":
                n = e.data("target"), $(n).removeClass("open"), $("body").find(".body-backdrop").remove();
                break;
            case "aside-open":
                n = e.data("target"), e.addClass("active"), $(n).addClass("show"), $("body").append(
                    '<div class="body-backdrop" data-action="aside-close" data-target=' + n + " />");
                break;
            case "aside-close":
                n = e.data("target"), e.removeClass("active"), $(n).removeClass("show"), $("body").find(
                    ".body-backdrop").remove();
                break;
            case "search-open":
                n = e.data("target"), e.addClass("active"), $(n).addClass("show"), $("body").addClass(
                    "navbar-search-open").append(
                    '<div class="body-backdrop body-backdrop-dark" data-action="search-close" data-target="' +
                    n + '" />');
                break;
            case "search-close":
                n = e.data("target"), $('[data-action="search-open"]').removeClass("active"), $(n).removeClass(
                    "show"), $("body").removeClass("navbar-search-open").find(".body-backdrop").remove()
        }
    }),
    Masonry = function () {
        ...
        a.length && a.each(function () {
            var a, e, t, n, o, i;
            a = $(this), e = a.find(".masonry"), t = a.find(".masonry-filter-menu"), n = t.find(".default"), o =
                n.data("filter"), i = e.imagesLoaded(function () {
    ...
    NavbarCollapse = function () {
        ...
        e.length && (e.on({
            ...
            "hide.bs.collapse": function () {
                e.removeClass("collapsing").addClass("collapsing-out"), a.removeClass(
                    "navbar-collapsed").addClass("navbar-collapsed-out"), t.removeClass(
                    "navbar-collapsed").addClass("navbar-collapsed-out")
            }
        }), e.on({
            "hidden.bs.collapse": function () {
                e.removeClass("collapsing-out"), a.removeClass("navbar-collapsed-out"), t.removeClass(
                    "navbar-collapsed-out")
            }
        }))
    }(),
    ...
    NegativeMargin = function () {
        ...
        $(window).on({
            "load resize": function () {
                a.length && a.each(function () {
                    var a, e;
                    a = $(this), e = a.find($(a.data("negative-margin"))).height(), console.log(e),
    ...
    SingleSlider = function () {
        ...
        a.length && a.each(function () {
            ...
            a = $(this), e = a.find(".input-slider"), t = e.attr("id"), n = e.data("range-value-min"), o = e.data(
                "range-value-max"), i = a.find(".range-slider-value"), s = i.attr("id"), r = i.data(
                "range-value-low"), l = document.getElementById(t), d = document.getElementById(s), c = {
                start: [parseInt(r)],
                connect: [!0, !1],
                range: {
                    min: [parseInt(n)],
    ...
    RangeSlider = function () {
        ...
        a.length && a.each(function () {
            var a, e, t, n;
            $(this), a = document.getElementById("input-slider-range"), e = document.getElementById(
                "input-slider-range-value-low"), t = document.getElementById(
                "input-slider-range-value-high"), n = [e, t], noUiSlider.create(a, {
                start: [parseInt(e.getAttribute("data-range-value-low")), parseInt(t.getAttribute(
        ...
        a.length && e.on({
            click: function () {
                ...
                function (a) {
                    ...
                    a.hasClass("active") || ($("." + e.attr("class") + " button[data-pricing]").removeClass(
                        "active"), a.addClass("active"), t.each(function () {
    ...
    Select = function () {
        ...
        function t(a) {
            ...
            return e ? $('<span class="avatar avatar-xs mr-3"><img class="avatar-img rounded-circle" src="' + e +
                '" alt="' + a.text + '"></span><span>' + a.text + "</span>") : a.text
        }
        a.length && a.each(function () {
            var a, e;
            a = $(this), e = {
        ...
        $(document).ready(function () {
            a.length && a.each(function (a, e) {
                ...
                function (a) {
                    ...
                    p = p || 1, u = u || p, f = f || u, g = g || f, h = h || g, v = v || 0, m = m || v,
                        w = w || m, b = b || w, y = y || b;
                    var $ = new Swiper(e, {
                        pagination: {
                            el: t,
