                        ...
                        <div class="container-fluid">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted m-b-30 font-14">这里可以设置您工单系统的一些参数，包括问题类型以及开关。</p>
												<div class="form-group">
                                                    ...
                                                    <div>
                                                    <select  class="form-control" name="owrk_zt"   id="owrk_zt"  >
												...
												<div class="form-group" >
                                                    <label>问题类型</label>
                                                    <div>
                                                       <textarea  name="owrk_ask"  rows="4" class="form-control"><?php echo $conf['owrk_ask'];?></textarea> 
                                                    </div>
                                                </div>
                         ...
                         <thead style="text-align: center;">
                                                <tr>
                                                    <th>用户账号</th>
		                                            <th>工单编号</th>
													<th style="display: none;">用户QQ号码</th>
		                                            <th>问题类型</th>
		                                            <th>工单标题</th>   
 ...
 $('#shanchu').on('show.bs.modal', function (event) {
      ...
      modal.find('.ca1').val(content);
		 ...
		 $("#work").click(function () {
						...
						var owrk_ask=$("textarea[name='owrk_ask']").val();
						var ii = layer.load(2, {shade: [0.1, '#fff']}); 
						$.ajax({
							type: "POST",
							url: "ajax.php?act=edit_Work",
							data: {owrk_zt:owrk_zt,owrk_ask:owrk_ask},
							dataType: 'json',
