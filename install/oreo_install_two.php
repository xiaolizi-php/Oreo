...
<div class="top">
	...
	<div class="top-link">
		<ul>
			...
			<li><a href="http://wpa.qq.com/msgrd?v=3&uin=2498131909&site=qq&menu=yes" target="_blank">联系作者</a></li>
			<li><a href="https://jq.qq.com/?_wv=1027&k=TT4zSevP" target="_blank">加入技术群</a></li>
		</ul>
	</div>
	...
	if(!$oreoconfig['user']||!$oreoconfig['pwd']||!$oreoconfig['dbname']) {
		...
		if(!$con=DB::connect($oreoconfig['host'],$oreoconfig['user'],$oreoconfig['pwd'],$oreoconfig['dbname'],$oreoconfig['port'])){
			...
			echo '<div class="alert alert-success">数据库配置文件保存成功！</div>';
                ...
                else echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过Oreo授权系统</div>
...
?>";
		if(!$con=DB::connect($db_host,$db_user,$db_pwd,$db_name,$db_port,$safer)){
			...
			if(DB::query("select * from ayangw_config where 1")==FALSE)
				...
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过Oreo授权系统</div>
				<div class="list-group-item">
					<a href="?do=6" class="btn btn-block btn-info">跳过安装</a>
				</div>
				<div class="list-group-item">
...
if($e==0) {
	echo '
		  ...
		  <div class="font">Oreo授权系统安装成功<br/>SQL成功'.$t.'句/失败'.$e.'句</div>
		  <div class="btn"><a href="oreo_install_two.php?do=4"><input name="" class="index_mian_right_seven_Forward_ly" type="button" value="完成安装" /></a></div>';
} else {
	echo '
	     <div class="index_mian_right_one_one_ly"><span>安装失败</span></div>
		 <div class="font">Oreo授权系统安装失败<br/>SQL成功'.$t.'句/失败'.$e.'句<br/>错误信息：'.$error.'<a href="oreo_install_two.php?do=3"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点此进行重试</a></div>';
}
?>
  </div>
  <!--进入系统-->
...
<div class="main">
  ...
  <div class="index_mian_right_one_one_ly"><span>安装完成</span></div>
		 <div class="font">Oreo负责任的告诉您！系统安装成功！默认账号：admin，密码：123456<br/>
...
$myfile = fopen("../oreo/oreo_static/oreo.jiance.php", "");
		 ?>
		 <div class="btn">
